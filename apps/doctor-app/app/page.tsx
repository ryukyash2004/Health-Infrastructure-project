    ...
    <div className="flex min-h-screen bg-slate-50 font-sans text-slate-900 selection:bg-blue-100">
      ...
      <main className="flex-1 ml-64 flex flex-col min-w-0">
        ...
        <div className="p-8 space-y-6 pb-32 max-w-6xl mx-auto w-full">
            ...
            <div className="flex items-center gap-5">
              ...
              <div>
                <div className="flex items-center gap-2 mb-0.5">
                  <h2 className="text-xl font-bold text-slate-900 leading-none">Priya Sharma</h2>
                  <span className="text-[10px] bg-slate-100 text-slate-500 px-2 py-0.5 rounded border border-slate-200 font-medium uppercase tracking-wider">AE-99201</span>
                </div>
                <div className="flex items-center gap-4 text-xs text-slate-500 font-medium">
                  <span>28 Yrs / Female</span>
                  <span>+91 98765 43210</span>
                  <span>Visit: 24 Oct 2024, 10:30 AM</span>
                  <span className="text-blue-600 font-bold">OPD</span>
                </div>
              </div>
            </div>
          ...
          <section className="bg-red-50 border border-red-100 rounded p-4 flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="p-2 bg-red-100 rounded">
                <AlertTriangle className="w-5 h-5 text-red-600" />
              </div>
              <div>
                <h3 className="text-xs font-bold text-red-800 uppercase tracking-widest mb-1">AI Triage Summary <span className="ml-2 text-[10px] font-medium opacity-70 underline">Read-Only</span></h3>
                <p className="text-sm font-bold text-red-900">Severity Index: Level 3 (Moderate Clinical Risk)</p>
              </div>
            </div>
            <div className="flex items-center gap-2">
              <span className="text-[10px] font-bold text-red-700 mr-2">Differential:</span>
              {['Acute Gastritis', 'GERD', 'Biliary Colic'].map(tag => (
                <span key={tag} className="px-2.5 py-1 bg-white border border-red-200 text-red-700 text-[10px] font-bold rounded">
                  {tag}
                </span>
              ))}
            </div>
          ...
          <div className="grid grid-cols-12 gap-6">
            ...
            <div className="col-span-12 lg:col-span-6 bg-white rounded border border-slate-200 shadow-sm p-6 space-y-4">
              ...
              <textarea 
                ...
                defaultValue="Patient reports persistent epigastric pain for 3 days, described as 'burning' and 'bloating'. Pain is worse 1 hour after dinner."
              />
            </div>
            ...
            <div className="col-span-12 lg:col-span-6 bg-white rounded border border-slate-200 shadow-sm p-6 space-y-4">
              ...
              <textarea 
                ...
                defaultValue="Pain started after a spicy meal. Partially relieved by milk. No history of melena, hematemesis, or significant weight loss. Stress levels high due to workplace."
              />
            </div>
